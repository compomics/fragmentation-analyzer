...
Download the latest version of `FragmentationAnalyzer_X.Y.zip` (where X and Y represent the version of the software) [here](http://genesis.ugent.be/maven2/no/uib/FragmentationAnalyzer/1.5.16/FragmentationAnalyzer-1.5.16.zip). Unzipping the file, creates the following directory structure:
